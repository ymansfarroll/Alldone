...
export const SUCCESSFUL_REQUEST_RESPONSE = { // HTTP request successful responses.
    ...
    PERSONAL_USER_INFORMATION = {
        ...
        */
        ...
        'fullname': {
            ...
            'optional': true,
            'errors': {
                'default': 'PAYLOAD_FULL_NAME_FIELD_IS_NOT_ALLOWED_TO_CONTAIN_OTHER_THAN_LETTERS'
