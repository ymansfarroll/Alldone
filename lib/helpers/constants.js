...
export const // HTTP request constants.
    ...
    UNSUCCESSFUL_REQUEST_STATUS = 400,
...
export const // JWT constants.
    ...
    JWT_TOKEN_EXPIRATION_TIME = 5 * 60;    
...
export const // Query unrecovered fields.
...
export const // Mongoose validation constants.

    // Reference to RFC 3696 - Application techniques for checking and transformation of names.
    EMAIL_VALIDATION_REGEX = /^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/,      
    EMAIL_VALIDATION_MESSAGE = 'INVALID_EMAIL_FIELD_AS_ATTEMPTED_TO_CREATE_A_USER_DEFINITION'; 
